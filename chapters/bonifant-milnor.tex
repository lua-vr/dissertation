...
\todo{move things to the skew product section under extensions}
...
\todo{the paragraph below conflicts, or should be moved to, the section which defines the empirical measures, as it's not clear whether it concerns an asymptotic measure for each point, or a single one for almost every point. If necessary, adjust the theorem statement.}
...
\todo{Perhaps a section should be dedicated to the hyperbolic metric, or the Hilbert metric. Perhaps put it next to the Hausdorff metric.}
