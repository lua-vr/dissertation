...
\begin{example}
  Let \(f \colon X \to \Meas[1]{X}\) be a \emph{Markov kernel} from a measurable set to itself. Then, examples of cones for the associated system in \(\Stoch\) over \(\NNZ\) are \emph{stationary measures} \(m \colon \set{\star} \to \Meas[1]{X}\), that is, measures with the property that 
  \begin{equation*}
