...
Donsker's theorem is far from being the most general result of its kind, and in our case, we are interested in a generalization of such weak invariance principle for ergodic martingale difference sequences. Intuitively, these are sequences that behave as the time-one steps of a martingale, in the sense that even with information about the previous steps the expected value of the next step is still zero.
